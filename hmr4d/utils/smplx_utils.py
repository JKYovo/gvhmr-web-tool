...
def make_smplx(type="neu_fullpose", **kwargs):
    if type == "neu_fullpose":
        ...
        model = BodyModelSMPLX(model_path=resolve_checkpoint_path("body_models"), **bm_kwargs)
        ...
        model = BodyModelSMPLH(model_path=resolve_checkpoint_path("body_models"), **bm_kwargs)

    elif type in ["smplx-circle", "smplx-groundlink"]:
        # don't use hand
        bm_kwargs = {
            "model_path": resolve_checkpoint_path("body_models"),
            "model_type": "smplx",
